        ...
        body: Center(
          child: Column(
            ...
            children: [
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [ElevatedButton(onPressed: () => {_openLihatJurnalPage(context)}, child: Text('Lihat Jurnal')),
                  SizedBox(width: 20),
                  ElevatedButton(onPressed: () => {_openBuatJurnalPage(context)}, child: Text('Buat Jurnal')),],
              ),
              SizedBox(height: 20),
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  ...
                  SizedBox(width: 20),
                  ElevatedButton(onPressed: () => {}, child: Text('Tentang Aplikasi')),
                ],
              )
            ],
          ),
